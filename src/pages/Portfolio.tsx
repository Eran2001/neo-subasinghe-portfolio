...
import { IMAGES } from '@/src/data/mockData';
...
const CATEGORIES = ['All', 'Portrait', 'Landscape', 'Editorial', 'Wedding', 'Urban'];
      ...
      <div className="max-w-7xl mx-auto">
          ...
          {filteredImages.map((img, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                <Badge className="w-fit mb-2 bg-accent hover:bg-accent border-none">{img.tags[0]}</Badge>
        ...
        {filteredImages.length === 0 && (
          <div className="text-center py-24">
            ...
            <Button variant="link" onClick={() => {setFilter('All'); setSearchQuery('');}}>Clear all filters</Button>
          </div>
        )}
      </div>
    </div>
