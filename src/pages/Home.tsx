...
import { IMAGES, ALBUMS, TESTIMONIALS } from '@/src/data/mockData';
...
export const Home = () => {
  return (
    <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <Link to="/portfolio">
              <Button variant="outline" className="rounded-full group">
                Explore Full Gallery <ArrowRight className="ml-2 transition-transform group-hover:translate-x-1" size={18} />
              </Button>
            </Link>
          </div>
            ...
            {IMAGES.slice(0, 6).map((img, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                  <BadgePill className="w-fit mb-3 bg-accent text-white border-none">{img.tags[0]}</BadgePill>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {ALBUMS.slice(0, 3).map((album, i) => (
              ...
              >
                <Link to={`/album/${album.id}`} className="relative aspect-[3/4] overflow-hidden rounded-3xl mb-6 block">
                  <img 
                    src={album.coverSrc} 
                    alt={album.title} 
                ...
                <div className="flex flex-col">
                  ...
                  <Link to={`/album/${album.id}`} className="text-sm font-bold uppercase tracking-widest flex items-center gap-2 hover:text-accent transition-colors">
      ...
      <section className="py-24 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <SectionHeading subtitle="Feedback" title="What Our Clients Say" centered />
        ...
        <div className="max-w-7xl mx-auto bg-primary rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-xl text-white/70 mb-12">
              Ready to capture your story? We're currently booking for 2024 and 2025.
            </p>
            <Link to="/contact">
              <Button size="lg" className="rounded-full px-12 py-8 text-xl bg-white text-primary hover:bg-white/90">
                Book a Session
              </Button>
            </Link>
          </div>
