    ...
    <div className="pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="aspect-[16/9] rounded-[3rem] overflow-hidden mb-16 shadow-xl">
            <img 
              src={post.coverSrc} 
              alt={post.title} 
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="text-lg leading-relaxed space-y-6">
              ...
              <h3 className="text-2xl font-bold mt-12 mb-6">The Importance of Vision</h3>
          ...
          <div className="mt-20 pt-12 border-t border-border flex flex-wrap gap-4 items-center justify-between">
            <div className="flex gap-2">
              {post.tags.map(tag => (
                <Badge key={tag} variant="outline" className="px-4 py-1 rounded-full">
                  #{tag}
                </Badge>
              ))}
            </div>
