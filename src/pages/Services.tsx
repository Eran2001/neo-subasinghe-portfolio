      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          {SERVICES.map((service, i) => (
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-accent font-black text-3xl">{service.priceRange}</p>
              </div>
              ...
              <Link to="/contact">
                <Button className="w-full rounded-full py-7 text-lg group">
                  Select Package <ArrowRight className="ml-2 transition-transform group-hover:translate-x-1" size={20} />
                </Button>
              </Link>
            </motion.div>
          ))}
        ...
        <section className="bg-dark rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <SectionHeading title="Custom Add-ons" subtitle="Enhance Your Session" className="mb-12" />
